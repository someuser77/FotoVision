...
namespace FotoVision
{
	public class DetailsPane : BasePane
	{
		...
		public DetailsMode Mode
		{
			...
			set
			{
				...
				case DetailsMode.PhotoDetails:
					...
					this.albumDetails.Visible = false;
					this.photoDetails.Visible = true;
					this.photoActions.Visible = false;
					this.Visible = true;
					break;
				case DetailsMode.PhotoActions:
					...
					this.CaptionText = "";
					this.albumDetails.Visible = false;
					this.photoDetails.Visible = false;
					this.photoActions.Visible = true;
					this.Visible = true;
					break;
				case DetailsMode.AlbumDetails:
					this.CaptionText = "Album Description";
					this.albumDetails.Visible = true;
					this.photoDetails.Visible = false;
					this.photoActions.Visible = false;
					this.Visible = true;
					break;
		...
		private void InitializeComponent()
		{
			...
			this.photoDetails.Name = "photoDetails";
			...
			this.photoActions.Name = "photoActions";
			...
			this.albumDetails.Name = "albumDetails";
			Control arg_1A0_0 = this.albumDetails;
			size = new Size(310, 346);
			arg_1A0_0.Size = size;
			this.albumDetails.TabIndex = 2;
